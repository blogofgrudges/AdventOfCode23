cards_scores = list('J23456789TQKA')
...
with open('puzzle_input', 'r') as file:
    for line in file:
        ...
        if 'J' in hand['cards'] and len(hand['cards'].keys()) > 1:  # catch if hand is entirely J
            sorted_cards_in_hand.remove(hand['cards']['J'])
            sorted_cards_in_hand.sort(reverse=True)
            sorted_cards_in_hand[0] += hand['cards']['J']
